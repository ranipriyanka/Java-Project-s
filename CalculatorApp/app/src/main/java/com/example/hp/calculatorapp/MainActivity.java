...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupUIViews(){
        ...
        eight=(Button)findViewById(R.id.button15);
        nine=(Button)findViewById(R.id.button16);
        zero=(Button)findViewById(R.id.button6);
        dot=(Button)findViewById(R.id.button5);
        ...
        equals=(Button)findViewById(R.id.button17);
